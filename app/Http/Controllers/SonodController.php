...
$filepath =  str_replace(' ', '_', $sonodEnName->enname);
        ...
        if($national_id_frontCount>1){
            $Insertdata['applicant_national_id_front_attachment'] =  fileupload($r->applicant_national_id_front_attachment,"sonod/$filepath/applicant_national_id_front_attachment/",250,300);
        }

        if($national_id_backCount>1){
            $Insertdata['applicant_national_id_back_attachment'] =  fileupload($r->applicant_national_id_back_attachment,"sonod/$filepath/applicant_national_id_back_attachment/",250,300);
        }

        if($birth_certificateCount>1){
            $Insertdata['applicant_birth_certificate_attachment'] =  fileupload($r->applicant_birth_certificate_attachment,"sonod/$filepath/applicant_birth_certificate_attachment/",250,300);
        }
