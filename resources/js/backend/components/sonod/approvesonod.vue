...
export default {
    ...
    mounted() {
        ...
        if (this.Details.sonod_name == 'নাগরিকত্ব সনদ') {
            ...
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই। আমার জানা মতে তার থাকার মতো এবং চাষাবাদ করার মত নিজস্ব কোনো জমি নেই । তিনি একজন ভূমিহীন মানুষ তাই তাকে ${this.Details.sonod_name} প্রদান করা হলো ।`;
        } else if (this.Details.sonod_name == 'পারবারিক সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। আমার জানা মতে সে ${this.Details.family_name} বংশের একজন উত্তরাধিকারী । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'অবিবাহিত সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। আমার জানামতে সে একজন অবিবাহিত পুরুষ । বিগত সময়ে তার কোন বিবাহ ছিলনা বা বিবাহ করেনি । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই ।`;
        } else if (this.Details.sonod_name == 'পুনঃ বিবাহ না হওয়া সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে একজন বিবাহিত পুরুষ এবং তাহার কোনো পুনঃ বিবাহ হয়নি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'বার্ষিক আয়ের প্রত্যয়ন') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। তার বার্ষিক আয় ${this.Details.Annual_income}/=  হাজার টাকা । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'একই নামের প্রত্যয়ন') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। প্রকাশ থাকে যে "${this.Details.applicant_name}" ও "${this.Details.applicant_second_name}" একই ব্যক্তি । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'অনুমতি পত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই। তাকে ${this.Details.Subject_to_permission} অনুমতি দেওয়া হল ।`;
        } else if (this.Details.sonod_name == 'প্রতিবন্ধী সনদপত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। আমার জানামতে সে একজন ${this.Details.disabled} প্রতিবন্ধী । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'অনাপত্তি সনদপত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সেই বর্তমানে প্রোগ্রামার পদে নিযুক্ত আছেন । তার পাসপোর্ট আবেদনের প্রয়োজনীয় কাগজপত্র এর সঙ্গে পেরন করা হলো  । ইতিপূর্বে পুলিশ ভেরিফিকেশন সম্পন্ন হয়েছে  । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'অগভীর নলকূপ স্থাপন') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই। তার বসতবাড়িতে বর্তমানে কোন টিউবওয়েল নেই । তাই তাকে অগভীর নলকূপ বসানোর অনুমতি দেওয়া হল ।`;
        } else if (this.Details.sonod_name == 'অবকাঠামো নির্মাণের অনুমতি পত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। বর্তমানে তার থাকার জন্য কোনো অবকাঠামো ও বসতবাড়ি নেই । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।  তাই তাকে অবকাঠামো নির্মাণের অনুমতি প্রদান করা হল ।`;
            ...
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। তার বর্তমান কর্মস্থল ${this.Details.The_subject_of_the_certificate}তে স্থানান্তরিত হয়েছে । তার কর্মস্থল সেখানে স্থায়ী হয়েছে তাই তার ভোটার স্থানান্তর করা জরুরি । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'জাতীয় পরিচয়পত্র সংশোধন প্রত্যয়ন') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। তার জাতীয় পরিচয় পত্র কিছু তথ্য অনাকাঙ্ক্ষিত ভুল হয়েছে এটি সংশোধন করা অতীব জরুরী । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'নিঃসন্তান প্রত্যয়নর') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। আমার জানামতে সে বিবাহিত কিন্তু তার কোন সন্তান নেই । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'ভোটার তালিকায় নাম অন্তর্ভুক্ত না হওয়ার প্রত্যয়ন') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে অসুস্থ থাকার কারণে ভোটার তালিকায় তার নাম অন্তর্ভুক্তি করন করা হয়নি । তার নামটি ভোটার তালিকায় অন্তর্ভুক্ত করার জন্য অনুরোধ করা হলো । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'সম্প্রদায় সনদপত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সম্প্রদায় নিয়ে লেখাগুলো এখানে হবে । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'আর্থিক অস্বচ্ছলতার সনদপত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে আমার ইউনিয়নের স্থায়ী বাসিন্দা এবং সে আর্থিকভাবে খুবি অসচ্ছল । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'জীবিত ব্যক্তির ওয়ারিশ সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে কোন রাষ্ট্রদ্রোহিতার অভিযোগ নেই। তাই তাকে ${this.Details.sonod_name} প্রদান করা হলো ।`;
        } else if (this.Details.sonod_name == 'এতিম সনদপত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। আমার জানা মতে তার বাবা-মা জীবিত নেই, সে একজন এতিম । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'জীবিত সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। জীবিত এবং সুস্থ আছেন । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'রিনিউ সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।  তাকে সনদ রিনিউ করার জন্য অনুমোদন দেওয়া হল ।`;
        } else if (this.Details.sonod_name == 'বসতবাড়ি হোল্ডিং নিবন্ধন সনদ') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে তার বসত বাড়ির জন্য হোল্ডিং নাম্বার নিয়েছে । সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
        } else if (this.Details.sonod_name == 'রোহিঙ্গা নয় মর্মে প্রত্যয়ন পত্র') {
            this.form.sec_prottoyon = `${this.Details.applicant_name} তাকে আমি ব্যক্তিগতভাবে চিনি ও জানি। সে রোহিঙ্গা নয়, সে জন্মসূত্রে বাংলাদেশের নাগরিক এবং অত্র ইউনিয়ন পরিষদের স্থায়ী বাসিন্দা। আমার জানামতে তারবিরুদ্ধে রাষ্ট্রদ্রোহিতার অভিযোগ নেই।`;
