...
<div class="col-md-4" v-if="attactType=='nid'">
  <div class="form-group">
    ...
    <input type="file" accept="image/*" class="form-control custom-file-input" @change="FileSelected3($event, 'applicant_national_id_front_attachment')" id="applicant_national_id_front_attachment" required>
    ...
    <img style="width: 100%;" thumbnail fluid v-if="form.applicant_national_id_front_attachment != null" :src="form.applicant_national_id_front_attachment" alt="Image 3" />
  </div>
</div>

<!-- জাতীয় পরিচয়পত্র (Back page) -->
<div class="col-md-4" v-if="attactType=='nid'">
  <div class="form-group">
    ...
    <input type="file" accept="image/*" class="form-control custom-file-input" @change="FileSelected3($event, 'applicant_national_id_back_attachment')" id="applicant_national_id_back_attachment" required>
    ...
    <img style="width: 100%;" thumbnail fluid v-if="form.applicant_national_id_back_attachment != null" :src="form.applicant_national_id_back_attachment" alt="Image 3" />
  </div>
</div>

<!-- Check Image Button -->
<div class="col-md-12" v-if="attactType=='nid'">
  <button type="button" class="btn btn-primary" @click="checkNIDImages">Check Image</button>
</div>
...
<div class="col-md-4" v-if="attactType=='dob'">
  <div class="form-group">
    ...
    <input type="file" accept="image/*" class="form-control custom-file-input" @change="FileSelected($event, 'applicant_birth_certificate_attachment')" id="applicant_birth_certificate_attachment" required>
    ...
    <img style="width: 100%;" thumbnail fluid v-if="form.applicant_birth_certificate_attachment != null" :src="form.applicant_birth_certificate_attachment" alt="Image 3" />
  </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" >
                            ...
                            <input type="text" v-model="Pdivision" class="form-control" required>
                        ...
                        <!-- <select   class='form-control' name="district" id="district" v-model="applicant_present_district" @change="getthanaFun" >
                            ...
                            <input type="text" class="form-control" v-model="form.applicant_present_district" required>
                        </div>
                        <div class="form-group">
                        ...
                        <!-- <select  class='form-control' name="thana" id="thana" v-model="form.applicant_present_Upazila" @change="getuniounFun" >
                            ...
                            <input type="text" class="form-control" v-model="form.applicant_present_Upazila" required>
                        </div>
                        <div class="form-group">
                            <label for="" class="labelColor">পোষ্ট অফিস</label>
                            <input type="text" class="form-control" v-model="form.applicant_present_post_office" required>
                        </div>
                        <div class="form-group">
                            <label for="" class="labelColor">ওয়ার্ড নং</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.applicant_present_village" required>
                        </div>
                        <!-- <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="Perdivision" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="form.applicant_permanent_district" required>
                        </div>
                        <div class="form-group">
                            <label for="" class="labelColor">উপজেলা/থানা</label>
                            ...
                            <input type="text" class="form-control" v-model="form.applicant_permanent_Upazila" required>
                        </div>
                        <div class="form-group">
                            <label for="" class="labelColor">পোষ্ট অফিস</label>
                            <input type="text" class="form-control" v-model="form.applicant_permanent_post_office" required>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="" class="labelColor">গ্রাম/মহল্লা</label>
                            <input type="text" class="form-control" v-model="form.applicant_permanent_village" required>
                        </div>
                        <!-- <div class="form-group">
                            <label for="" class="labelColor">রোড/ব্লক/সেক্টর</label>
...
export default {
    ...
    methods: {
        ...
        FileSelected3(event, fieldName) {
  const file = event.target.files[0];
  this.form[fieldName] = URL.createObjectURL(file);
  this.formData[fieldName] = file;
  console.log('File selected:', file); // Debugging line
},

  // Method to upload NID images
  async checkNIDImages() {
    try {
      const formData = new FormData();

      // Add front and back images to the form data
      if (this.formData.applicant_national_id_front_attachment) {
        formData.append('applicant_national_id_front_attachment', this.formData.applicant_national_id_front_attachment);
      } else {
        alert('Please upload the front image of the NID.');
        return;
      }

      if (this.formData.applicant_national_id_back_attachment) {
        formData.append('applicant_national_id_back_attachment', this.formData.applicant_national_id_back_attachment);
      } else {
        alert('Please upload the back image of the NID.');
        return;
      }

      // Send the POST request to the server
      const response = await axios.post('/api/nid-images/upload', formData, {
        headers: {
    ...
    //   console.log(response.data);
      var niddate = response.data;

      this.form['applicant_name'] = niddate.name_bengali;
      this.form['applicant_father_name'] = niddate.father_name;
      this.form['mother_name'] = niddate.mother_name;
      this.form['applicant_date_of_birth'] = niddate.date_of_birth;
      this.form['applicant_national_id_number'] = niddate.nid_no;


      this.form['applicant_present_village'] = niddate.village_road;
      this.form['applicant_present_post_office'] = niddate.post_office;
      this.form['applicant_present_Upazila'] = niddate.thana;
      this.form['applicant_present_district'] = niddate.district;


      this.form['applicant_permanent_village'] = niddate.village_road;
      this.form['applicant_permanent_post_office'] = niddate.post_office;
      this.form['applicant_permanent_Upazila'] = niddate.thana;
      this.form['applicant_permanent_district'] = niddate.district;
